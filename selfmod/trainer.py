            ...
            for env_batch, batch in enumerate(dataloader):
                ...
                for out_step in range(nb_outer_steps):
                    ...
                    for in_step_ctx in range(nb_inner_steps_ctx):
                        ...
                        model, contexts, opt_state_ctx, loss_ctx, (term1, term2, _, loss_contrs, _) = train_step_ctx(model, contexts, contexts_old, batch, all_env_losses, opt_state_ctx, loss_key)
                    ...
                    if loss_filling == "NF-iW":
                        ...
                        # all_env_losses = all_env_losses.at[loss_sort[:nb_envs_in_batch//2]].set(0.)
