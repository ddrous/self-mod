...
nb_outer_steps = 4*30*4*10*4
nb_inner_steps_max = 500
proximal_beta = 1e5 ## See beta in https://proceedings.mlr.press/v97/li19n.html
inner_tol = 5e-7
...
if train == True:
    ...
    for i, prop in enumerate(np.linspace(1.0, 1.0, 1)):
        ...
        trainer.train_proximal(nb_outer_steps=nb_outer_steps, nb_inner_steps_max=nb_inner_steps_max, proximal_reg=proximal_beta, inner_tol=inner_tol,
