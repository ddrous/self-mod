...
contexts = IDContextParams(nb_envs=nb_envs, context_size=context_size, hidden_size=32, depth=4, key=seed)

augmentation = Augmentation(data_size=2, int_size=64, context_size=context_size, ctx_utils=contexts.ctx_utils, key=seed)
...
print("\n\nTotal number of parameters in the context:", contexts.params.shape[1], "\n\n")
