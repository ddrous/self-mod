...
class Trainer:
    ...
    def train_proximal(self, nb_outer_steps, int_prop=1.0, inner_tol_node=1e-2, inner_tol_ctx=1e-2, nb_inner_steps_max=10, proximal_reg=100., print_error_every=1, save_path=False, val_dataloader=None, val_criterion=None, key=None):
