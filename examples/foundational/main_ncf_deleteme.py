...
max_train_batches = 1
max_adapt_batches = 1
proximal_betas = (10., 10., 10.)       ## For the model, context and the gate, in that order

nb_outer_steps = 500
nb_inner_steps = (10, 10, 10000)
nb_adapt_epochs = 500
validate_every = 50*1
...
class Model(eqx.Module):
    ...
    def __call__(self, t, y, ctx):
        ...
        for i in range(self.n_experts):
            ...
            contribution = jax.lax.cond(G[i]>1e-4, 
...
contexts = ArrayContextParams(nb_envs=num_envs[0], context_size=context_size, key=model_key)
