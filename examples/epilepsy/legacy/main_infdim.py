#%%[markdown]
# Use an infdim NCF for this task
...
print("Labels:", labels)
color_table = {0:"red", 1:"royalblue"}
colors = [color_table[l] for l in labels]

import umap
umap_reducer = umap.UMAP(n_components=2, random_state=time.time_ns()%(2**32), min_dist=0.0, spread=0.1, metric="euclidean")
