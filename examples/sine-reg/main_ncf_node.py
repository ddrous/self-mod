...
print_error_every = (100, 1)   ## every 1000 epochs, every 1 batch

nb_adapt_epochs = 100
nb_inner_steps_eval = 500       ## To use during evaluation and visulisation
...
model = NeuralODE(neuralnet=neuralnet, 
                    ...
                    ivp_args=ivp_args)  ## equal chances for taylor or not
