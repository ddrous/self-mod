...
class MultiMLP(eqx.Module):
    ...
    def __init__(self, data_size, hidden_size, context_size, key=None):
        ...
        self.layers_data = [eqx.nn.Linear(data_size, hidden_size, key=keys[3]), self.activations[2], 
...
neuralnet = MultiMLP(data_size=3,
                     hidden_size=128, 
